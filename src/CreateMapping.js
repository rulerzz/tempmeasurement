...
const CreateMapping = () => {
    ...
    const generateResource = (e) => {
        ...
        axios.post("http://localhost:3001/node/generatemapping", sendData)
            .then((result) => {
                                    ...
                                    <div className="row g-2">
                                        <table className="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row"><input className="form-check-input me-2" type="checkbox" name="resource" value="3,4,10" onChange={handleCheckboxChange}/></th>
                                                ...
                                                <tr>
                                                    <th scope="row"><input className="form-check-input me-2" type="checkbox" name="resource" value="7,10" onChange={handleCheckboxChange}/></th>
                                                    <td colSpan="3">Visualization 7 & 10</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><input className="form-check-input me-2" type="checkbox" name="resource" value="9" onChange={handleCheckboxChange}/></th>
